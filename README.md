...
- I'm dong this project to learn more about CI/CD and get hands on experience in automating the from developing code to deployed web app.
- TThis fits into my career goals because I want to become a DevOps engineer this year!
...
1. Clone the repository:
    ```bash
    git clone https://github.com/nujabesploo/nextwork-web-project.git
    ```
...
Tife Alli - [tifealli28@gmail.com](mailto:email@example.com)

- [LinkedIn](https://www.linkedin.com/in/tife-alli-66090b185/)
